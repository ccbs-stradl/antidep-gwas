...
## Fixed-effects meta-analysis cohort sample sizes

```{r fixedn, echo = FALSE, warning = FALSE, message = FALSE}
cohort_summary_fixed <- read_csv(here::here("manuscript/tables/meta_analysis_cohort_summary_table_fixed.csv"))
cohort_summary_fixed |>
  ...
  select(ATC, cluster, cohort, cases, controls, neff)
```
