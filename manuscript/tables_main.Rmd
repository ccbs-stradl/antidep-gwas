...
```{r hits}
# clumped hits
clumps_fixed <- read_csv(here::here("manuscript/tables/clumps_fixed_antidep-2501.clumps.csv"))
clumps_mrmega <- read_csv(here::here("manuscript/tables/clumps_mrmega_antidep-2501.clumps.csv"))

clumps <- bind_rows(clumps_fixed, clumps_mrmega) |>
  group_by(dataset) |>
  count(name = "nsnps") |>
  ungroup() |>
