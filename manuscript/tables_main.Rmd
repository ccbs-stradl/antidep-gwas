...
drug_targets <- drug_targets_class |>
  ...
  transmute(ATC = CODE, Name = str_to_title(NAME), N, AUC, `Q value` = q_valueBH)
```

**Table `r drug_target_table_n`:** Drug target enrichment. ATC = Anatomical
...
**Table `r gwas_summary_table_n`:** Comparison of results to major depression GWAS.
