...
- `gwas`: scripts and notebooks for GWAS in each contributing cohort

- `ad-exposure-classes.*`: munge meta-analysed sumstats for Genomic SEM

- `ad-exposure-mdd-pain.*`: Genomic SEM modelling notebook
