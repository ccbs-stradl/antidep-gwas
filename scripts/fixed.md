...
``` r
ggsave(here::here("scripts/fixed_files/figure-gfm/manhattan_n06a-1.pdf"), width = 12, height = 6.75)
```
...
![](fixed_files/figure-gfm/manhattan_n06aa-1.png)<!-- -->
...
![](fixed_files/figure-gfm/manhattan_n06ab-1.png)<!-- -->
