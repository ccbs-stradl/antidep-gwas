...
# clumps_gw_nomhc_gr_N06AA <- get_clumps("antidep-2501-mrmega-N06AA-DIV.clumps.tsv", mrmega_n06aa_assoc)
# clumps_gw_nomhc_gr_N06AB <- get_clumps("antidep-2501-mrmega-N06AB-DIV.clumps.tsv", mrmega_n06ab_assoc)
```
