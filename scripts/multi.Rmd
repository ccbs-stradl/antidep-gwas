...
```{r multi_manhattan_n06a, fig.width=8, fig.height=4.5, dpi=300, cache = TRUE}
plot_manhat(mrmega_n06a_assoc)

```


```{r multi_manhattan_n06aa, fig.width=8, fig.height=4.5, dpi=300, cache = TRUE}
plot_manhat(mrmega_n06aa_assoc)

```


```{r multi_manhattan_n06ab, fig.width=8, fig.height=4.5, dpi=300, cache = TRUE}
